# Contributing to ember-codemod-add-missing-tests

Open source projects like `ember-codemod-add-missing-tests` live on your words of encouragement and contribution. Please give feedback, report issues, or submit pull requests!
...
1. Fork and clone this repo.
    ...
    ```sh
    git clone git@github.com:<your-github-handle>/ember-codemod-add-missing-tests.git
    ```

1. Change directory.

    ```sh
    cd ember-codemod-add-missing-tests
    ```
...
1. [Create a tag](https://github.com/ijlee2/ember-codemod-add-missing-tests/releases/new) and provide release notes. The tag name should match the workspace root's version (e.g. `0.1.2`).
